...
def main():
    ...
    ellipseSource = vtkParametricFunctionSource()
    ellipseSource.SetParametricFunction(ellipsoid)
    ellipseSource.SetScalarModeToPhase()
    geometricObjectSources.append(ellipseSource)
