...
def main(argv):
    ...
    #
    # vtkPolyDataMapper maps the polygonal data into graphics primitives. We
    ...
    # try changing the color of cone
    ...
    # Coordinates are expressed as (xmin,ymin,xmax,ymax), where
    ...
    # set the size to be 900 pixels by 600.
    #
    renWin = vtkRenderWindow()
    renWin.AddRenderer(ren1)
    renWin.AddRenderer(ren2)
    renWin.SetSize(900, 600)
    renWin.SetWindowName('Multiple Renderers')
